...
# Renombramos
Phylum_R_DF$Phylum[Phylum_R_DF$Abundance < 0.10] <- "Phylum < 0.050% abundance"
Genus_R_DF$Phylum[Genus_R_DF$Abundance < 0.10] <- "Phylum < 0.050% abundance"
Genus_R_DF$Family[Genus_R_DF$Abundance < 0.50] <- "Family < 0.10% abundance"
Genus_R_DF$Genus[Genus_R_DF$Abundance < 0.50] <- "Genus < 0.10% abundance"
# Quitamos 
Phylum_R_DF <- filter(Phylum_R_DF, Phylum_R_DF$Phylum != "Phylum < 0.050% abundance")
Genus_R_DF <- filter(Genus_R_DF, Genus_R_DF$Phylum != "Phylum < 0.050% abundance")
Genus_R_DF <- filter(Genus_R_DF, Genus_R_DF$Family != "Family < 0.10% abundance")
Genus_R_DF <- filter(Genus_R_DF, Genus_R_DF$Genus != "Genus < 0.10% abundance")
```
...
```{r}
OnePercentage <- unique(Genus_R_DF$Phylum[Genus_R_DF$Abundance > 0.10])
OnePercentage
```
...
Phylum_A_DF$Phylum[Phylum_A_DF$Abundance < 1000] <- "Phylum < 1000 abundance"
Genus_A_DF$Phylum[Genus_A_DF$Abundance < 1000] <- "Phylum < 1000 abundance"
Genus_A_DF$Family[Genus_A_DF$Abundance < 10000] <- "Family < 10000 abundance"
Genus_A_DF$Genus[Genus_A_DF$Abundance < 15000] <- "Genus < 15000 abundance"
# Quitamos 
Phylum_A_DF <- filter(Phylum_A_DF, Phylum_A_DF$Phylum != "Phylum < 1000 abundance") 
Genus_A_DF <- filter(Genus_A_DF, Genus_A_DF$Phylum != "Phylum < 1000 abundance")
Genus_A_DF <- filter(Genus_A_DF, Genus_A_DF$Family != "Family < 10000 abundance")
Genus_A_DF <- filter(Genus_A_DF, Genus_A_DF$Genus != "Genus < 15000 abundance")
...
Genus_R_DF$Family[Genus_R_DF$Abundance < 1.0] <- "Family < 1.0% abundance"
Genus_R_DF$Genus[Genus_R_DF$Abundance < 1.0] <- "Genus < 1.0% abundance"
# Quitamos 
