...
```{r}
Phy <- tax_glom(psd5, taxrank = 'Phylum')
Phy <- psmelt(Phy)
Phy <- Phy[sort(Phy$Abundance, decreasing = F)]
  
  
  
psd5_phylum <- tax_glom(psd5, taxrank = 'Phylum')
Phy <- unique(sort(psd5@tax_table@.Data[,"Phylum"]))
